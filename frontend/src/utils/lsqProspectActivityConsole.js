/**
 * LeadSquared debug helper (server `lsqProspectActivityDebug` / `debug.lsqProspectActivity`).
 * Console output disabled — re-enable locally if needed for integration debugging.
